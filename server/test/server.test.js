...
describe('PATCH /todos/:id', () => {
	...
	it('should not clear completedAt when todo is not completed set by another user', (done) => {
		var hexId = todos[1]._id.toHexString();
		var text = 'updated second todos';
		request(app)
			.patch(`/todos/${hexId}`)
